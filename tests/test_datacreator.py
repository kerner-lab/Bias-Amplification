...
class TestingBiasValidation:
    ...
    def test_datacreator_returns_correct_M_unbias(self):
        ...
        #asserting tests
        assert tot_errors_in_M_unbias == tot_err_cnt, f"M_unbias should have a total of {tot_err_cnt} errors"
        assert errors_in_quarter_1 == errors_in_quarter_2 == err_cnt_half//2, f"M_unbias should have {err_cnt_half//2} errors in quarter 1 and 2"
        assert errors_in_quarter_3 == errors_in_quarter_4 == err_cnt_half - err_cnt_half//2, f"M_unbias should have {err_cnt_half - err_cnt_half//2} errors in quarter 3 and 4"
    ...
    def test_datacreator_returns_correct_M2(self):
        ...
        assert errors_in_half_1 == errors_in_half_2 == err_cnt_half, f"M2 should have {err_cnt_half} errors in each half"
        assert errors_in_quarter_1 == errors_in_quarter_4 == err_cnt_half, f"M2 should have {err_cnt_half} errors in quarter 1 and 4"
        assert errors_in_quarter_2 == errors_in_quarter_3 == 0, f"M2 should have zero errors in quarter 2 and 3"
